...
const SectionBadge: React.FC<SectionBadgeProps> = ({
	...
	return (
		<div className={cn('mb-3', className)}>
			<p className='inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-full bg-background px-3 py-1 text-xs font-medium text-zinc-500 dark:text-zinc-400 shadow-sm shadow-black/[.12] dark:bg-accent/60 hover:bg-accent/80 transition-colors'>
				{icon && (
